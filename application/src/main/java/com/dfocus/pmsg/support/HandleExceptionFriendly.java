...
// public Response<Void> methodArgumentNotValidException(MethodArgumentNotValidException
// ex) {
// log.info("校验参数出现异常", ex);
// StringBuilder errors = new StringBuilder();
...
// return Response.error(ResultCode.UNKNOWN_ERROR.getCode(),
// ResultCode.UNKNOWN_ERROR.getMsg());
// }
//
// }
